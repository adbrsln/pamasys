               ...
               <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form method="POST" action = "pproses.php">
                                 <label>Name</label> </br>
                                   <input class="form-control"  type="text" name = "pname" value ="<?php echo $row2['patientName']; ?>"  required>
                                     </br>
                                <label>Identification Card No.</label> </br>
                                           <input class="form-control"  type="text" name = "pic" value ="<?php echo $row2['patientIc']; ?>" maxlength="12" required>
                                             </br>
                                <label>Address</label> </br>
                                           <input class="form-control"  type="text" name = "address" value ="<?php echo $row2['patientAddress']; ?>" required>
                                             </br>
                                <label>Phone Number</label> </br>
                                           <input class="form-control"  type="text" name = "notel" value ="<?php echo $row2['patientPhoneNumber']; ?>"maxlength="11" required>
                                             </br>
                                             <input type="hidden" name ="pid" value = "<?php echo $row2['patientID']; ?>" >
