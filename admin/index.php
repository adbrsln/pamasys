...
$sql2 = "SELECT DISTINCT diagnosis.pid as pid,diagnosis.diagid as did,diagnosis.checkin as timecheckin,diagnosis.status as status ,patient.patientID,patient.name as name ,patient.ic as ic FROM diagnosis join patient on diagnosis.pid = patient.patientID WHERE status != 'Complete' ORDER BY diagnosis.checkin ASC";
