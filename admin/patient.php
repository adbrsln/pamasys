                                            ...
                                            <?php $total_rows = 1; while($row2 = mysqli_fetch_assoc($result2)){  ?>
                                              <tr>
                                                ...
                                                <td ><center>
                                                    ...
                                                    <a  data-toggle="tooltip" data-placement="top" title="Delete Records"  id = "confirmation"  class = "btn btn-danger btn-sm"  href="del.php?id=<?=$row2['patientID'];?>&t=<?= 'pr'?>" ><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Delete</a></center></td>
                                              </tr>
                                             <?php $total_rows++; }  ?> 
