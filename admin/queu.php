               ...
               <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong>Adding a new Inpatient?</strong> Try out <a data-toggle="modal" data-target="#myModal" class="alert-link">Here</a>
                        </div>
                    </div>
                </div>
               <div class="row">
                                        ...
                                        <tbody>
                                            <?php $total_rows = 1; while($row2 = mysqli_fetch_assoc($result2)){  ?>
                                              <tr>
                                                ...
                                                <td ><center><a  class = "btn btn-primary btn-sm"  href="ireg.php?id=<?=$row2['num'];?>" data-toggle="tooltip" data-placement="top" title="Attended"><span class="glyphicon glyphicon-eye-open" ></span></a>&nbsp;
                                                    <a   onclick = "return del();" class = "btn btn-success btn-sm" onclick="return del()" href="del.php?id=<?=$row2['num'];?>&t=<?= 'i'?> " data-toggle="tooltip" data-placement="top" title="Complete" ><span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span></a>&nbsp;
                                                    <a   onclick = "return del();" class = "btn btn-danger btn-sm" onclick="return del()" href="del.php?id=<?=$row2['num'];?>&t=<?= 'i'?>" data-toggle="tooltip" data-placement="top" title="Cancel"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></center></td>
                                              </tr>
                                             <?php $total_rows++; }  ?> 
